...
mod tests {
    ...
    fn live_base_config(
        ...
        Config {
            ...
            ipfs_hedge_delay_ms: 0,
            ipfs_negative_cache_seconds: 0,
            ipfs_negative_cache_not_found_seconds: 0,
            ipfs_negative_cache_capacity: 0,
            ipfs_negative_cache_cid_threshold: 0,
            ...
            metrics_top_failure_collections: 0,
            metrics_top_sources: 0,
            ...
            render_queue_soft_limit: 0,
            render_layer_concurrency: 1,
            render_timeout_seconds: 0,
            render_request_timeout_seconds: 0,
